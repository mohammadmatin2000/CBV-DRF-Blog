...
STATIC_ROOT = BASE_DIR / 'static'  # Specifies the directory for collected static files

MEDIA_URL = '/media/'  # Defines the URL for media files
MEDIA_ROOT = BASE_DIR / 'media'  # Specifies the directory for uploaded media files

STATICFILES_DIRS = [
    BASE_DIR / 'staticfiles',  # Defines additional static file directories
]
